...
class TaskItem extends HTMLElement {
  // `private` = only code INSIDE this class may touch it. `shadow` holds
  // the card's ShadowRoot (the root of its private mini-document).
  // Declaring the FIELD here (instead of a local variable in the
  // constructor) means every method of the class can reach it via `this`.
